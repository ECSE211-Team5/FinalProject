...
public enum WiFi {
  ...
  private static final String SERVER_IP = "192.168.2.48";
  ...
  public static void readData() {
    ...
    try {
      ...
      if (GameParameters.Demo == GameParameters.DemoType.Beta) {
         ...
         * GameParameters.OPPO_UR[0] - GameParameters.OPPO_LL[0] > 8 || GameParameters.OPPO_UR[1] -
         * GameParameters.OPPO_LL[1] < 2 || GameParameters.OPPO_UR[1] - GameParameters.OPPO_LL[1] >
         * 8) { throw new Exception("Green zone coordinates out of bounds"); }
         * 
         ...
         * GameParameters.Island_UR[1] - GameParameters.Island_LL[1] > 8) { throw new
         * Exception("Green zone coordinates out of bounds"); }
         * 
         * 
         * if (GameParameters.TTEE_O[0] < 0 || GameParameters.TTEE_O[0] > 7 ||
         * GameParameters.TTEE_O[1] < 0 || GameParameters.TTEE_O[1] > 7) { throw new
         * Exception("Green tree coordinates out of bounds"); }
         **/
      } else {
        ...
        /**
         * if (GameParameters.US_UR[0] - GameParameters.US_LL[0] < 2 || GameParameters.US_UR[0] -
         * GameParameters.US_LL[0] > 10 || GameParameters.US_UR[1] - GameParameters.US_LL[1] < 2 ||
         * GameParameters.US_UR[1] - GameParameters.US_LL[1] > 10) { throw new Exception("Red zone
         * coordinates out of bounds"); }
         * 
         * if (GameParameters.OPPO_UR[0] - GameParameters.OPPO_LL[0] < 2 ||
         * GameParameters.OPPO_UR[0] - GameParameters.OPPO_LL[0] > 10 || GameParameters.OPPO_UR[1] -
         * GameParameters.OPPO_LL[1] < 2 || GameParameters.OPPO_UR[1] - GameParameters.OPPO_LL[1] >
         * 10) { throw new Exception("Green zone coordinates out of bounds"); }
         * 
         * if (GameParameters.Island_UR[0] - GameParameters.Island_LL[0] < 2 ||
         * GameParameters.Island_UR[0] - GameParameters.Island_LL[0] > 10 ||
         * GameParameters.Island_UR[1] - GameParameters.Island_LL[1] < 2 ||
         * GameParameters.Island_UR[1] - GameParameters.Island_LL[1] > 10) { throw new
         * Exception("Island zone coordinates out of bounds"); }
         * 
         * if (GameParameters.TN_UR[0] - GameParameters.TN_LL[0] < 1 || GameParameters.TN_UR[0] -
         * GameParameters.TN_LL[0] > 2 || GameParameters.TN_UR[1] - GameParameters.TN_LL[1] < 1 ||
         * GameParameters.TN_UR[1] - GameParameters.TN_LL[1] > 2) { throw new Exception("Red tunnel
         * coordinates out of bounds"); }
         * 
         * 
         * if (GameParameters.TREE_US[0] < 0 || GameParameters.TREE_US[0] > 14 ||
         * GameParameters.TREE_US[1] < 0 || GameParameters.TREE_US[1] > 8) { throw new
         * Exception("Red tree coordinates out of bounds"); }
         * 
         * if (GameParameters.TTEE_O[0] < 0 || GameParameters.TTEE_O[0] > 14 ||
         * GameParameters.TTEE_O[1] < 0 || GameParameters.TTEE_O[1] > 8) { throw new
         * Exception("Green tree coordinates out of bounds"); }
         **/
      }
